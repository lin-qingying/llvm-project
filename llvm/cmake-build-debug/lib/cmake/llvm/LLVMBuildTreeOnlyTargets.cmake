...
set_target_properties(FileCheck PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-debug/bin/FileCheck.exe"
  )
...
set_target_properties(llvm-PerfectShuffle PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-debug/bin/llvm-PerfectShuffle.exe"
  )
...
set_target_properties(count PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-debug/bin/count.exe"
  )
...
set_target_properties(not PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-debug/bin/not.exe"
  )
...
set_target_properties(UnicodeNameMappingGenerator PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-debug/bin/UnicodeNameMappingGenerator.exe"
  )
...
set_target_properties(yaml-bench PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-debug/bin/yaml-bench.exe"
  )
...
set_target_properties(lli-child-target PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-debug/bin/lli-child-target.exe"
  )
...
set_target_properties(llvm-jitlink-executor PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-debug/bin/llvm-jitlink-executor.exe"
  )
...
set_target_properties(obj2yaml PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-debug/bin/obj2yaml.exe"
  )
...
set_target_properties(yaml2obj PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-debug/bin/yaml2obj.exe"
  )
