...
foreach(_cmake_expected_target IN ITEMS FileCheck llvm-PerfectShuffle count not UnicodeNameMappingGenerator yaml-bench lli-child-target llvm-jitlink-executor obj2yaml yaml2obj)
...
set_target_properties(FileCheck PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-release/bin/FileCheck.exe"
  )
...
set_target_properties(llvm-PerfectShuffle PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-release/bin/llvm-PerfectShuffle.exe"
  )
...
set_target_properties(count PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-release/bin/count.exe"
  )
...
set_target_properties(not PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-release/bin/not.exe"
  )
...
set_target_properties(UnicodeNameMappingGenerator PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-release/bin/UnicodeNameMappingGenerator.exe"
  )
...
set_target_properties(yaml-bench PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-release/bin/yaml-bench.exe"
  )
...
set_target_properties(lli-child-target PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-release/bin/lli-child-target.exe"
  )
...
set_target_properties(llvm-jitlink-executor PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-release/bin/llvm-jitlink-executor.exe"
  )
...
set_target_properties(obj2yaml PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-release/bin/obj2yaml.exe"
  )
...
set_target_properties(yaml2obj PROPERTIES
  IMPORTED_LOCATION_RELEASE "D:/code/llvm-project/llvm/cmake-build-release/bin/yaml2obj.exe"
  )
